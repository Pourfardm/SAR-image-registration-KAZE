...
buildingDir = fullfile('F:\MATLAB\descriptors\stitch\imageStitchMatlab\imageStitchMatlab\img\air\test');%***good
% buildingDir = fullfile('D:\MATLAB\descriptors\our code\panoram final\test_special');%***good
...
for n = 2:numImages
    ...
    figure(3),showMatchedFeatures_separate_4points(grayImage,grayImage_prev,matchedPoints,matchedPointsPrev);
    legend('matched points 1','matched points 2');
    drawnow;
    
    grayImage_prev=grayImage;
    tforms(n) = fitgeotrans(matchedPoints,matchedPointsPrev,'projective');
